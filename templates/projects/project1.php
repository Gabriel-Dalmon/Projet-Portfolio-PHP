    ...
    <body class="main-bg main-font-color">
        ...
        <main>
            <div class="parallax-container">
                <div class="parallax"><img src="../img/project1/bg_1.webp" alt="Minecraft Background of Parallax 1"></div>
            </div>
            <div class="container section row flow-text">
                <h1 class="col s12 center-align">Développement Frontend d'un Site Minecraft</h1>
                ...
                <div class="col s12 row flow-text">
                    ...
                    <p class="col s12">Les contraintes initiales du cahier des charges étaient : un menu de navigation entre les différentes pages/parties du site, une introduction résumant le concept du jeu, des photos/images/screenshots du jeu,
                        ...
                        Avec mon binome on a voulu essayer de faire en sorte que le site soit immersif.</p>
                </div>
            </div>
            <div class="parallax-container">
                <div class="parallax"><img src="../img/project1/bg_2.webp" alt="Minecraft Background of Parallax 2"></div>
            </div>
            <div class="container section row flow-text">
                ...
                <div class="col s12 center-align flow-text cgrid-padding">
                    ...
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project1/welcome_screen.webp" alt="Frontend de l'écran d'accueil du projet">
                        <p>Écran d'accueil</p>
                    </div>
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project1/presentation.webp" alt="Frontend de la présentation du jeu">
                        <p>Présentation du jeu</p>
                    </div>
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project1/content.webp" alt="Frontend du contenu du projet">
                        <p>Contenu de la page</p>
                    </div>
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project1/footer.webp" alt="Frontend du pied de page du projet">
                        <p>Pied de page</p>
                    </div>
                </div>
                <div>
