    ...
    <body class="main-bg main-font-color">
        ...
        <main>
            <div class="parallax-container">
                <div class="parallax"><img src="../img/project3/bg_1.webp" alt="Informatic Developer Background of Parallax 1"></div>
            </div>
            <div class="container section row flow-text">
                <h1 class="col s12 center-align">Développement Frontend d'un Portfolio</h1>
                <div class="col s12 row flow-text">
                    <h2 class="col s12 center-align">Introduction</h2>
                    <p class="col s12">L'objectif était de développer un site internet présentant vos projets réalisés en cours et vos projets personnels.</p>
                </div>
                <div class="col s12 row flow-text">
                    <h2 class="col s12 center-align">Description</h2>
                    <p class="col s12">Nous devions choisir 3 de nos projets à afficher sur le site, les présenter sur la page d’accueil du site mais également sur des page respectives (3 pages),
                        ...
                        3 événements changeant l’apparence d’un élément de votre site (easter egg).
                        </p>
                </div>
            </div>
            <div class="parallax-container">
                <div class="parallax"><img src="../img/project3/bg_2.webp" alt="Informatic Developer Background of Parallax 1"></div>
            </div>
            <div class="container section row flow-text">
                ...
                <div class="col s12 center-align flow-text cgrid-padding">
                    ...
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project3/welcome_screen.webp" alt="Frontend de l'écran d'accueil du projet">
                        <p>Écran d'accueil</p>
                    </div>
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project3/presentation.webp" alt="Frontend de la présentation du jeu">
                        <p>Présentation du jeu</p>
                    </div>
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project3/content.webp" alt="Frontend du contenu du projet">
                        <p>Contenu de la page</p>
                    </div>
                    <div class="col s12 m6">
                        <img class="wrapped" src="../img/project3/footer.webp" alt="Frontend du pied de page du projet">
                        <p>Pied de page</p>
                    </div>
                </div>
